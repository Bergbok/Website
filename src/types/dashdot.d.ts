// https://github.com/MauriceNino/dashdot/blob/main/packages/common/src/types.ts

export interface HardwareResponse {
	os: Pick<OsInfo, 'arch' | 'platform' | 'uptime'>;
	cpu: Omit<CpuInfo, 'ecores' | 'pcores'> & { load: CpuLoad };
	gpu: GpuInfo & { load: GpuLoad['layout'] };
	ram: Pick<RamInfo, 'size'> & RamLoad;
	network: NetworkInfo;
}
